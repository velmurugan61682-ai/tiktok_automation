...
const AuthPortal: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-[#0b0b10] text-slate-800 dark:text-slate-100 font-sans antialiased transition-colors duration-300">
      ...
      <div className="flex-1 tt-auth-shell flex items-center justify-center p-4 sm:p-6 relative overflow-hidden my-6">
        <div className="tt-signal-grid"></div>

        <div className="tt-auth-panel w-full max-w-5xl rounded-3xl overflow-hidden flex flex-col md:flex-row relative z-10 animate-fade-in shadow-2xl border border-slate-200/80 dark:border-slate-800">
          
          {/* Left column marketing splash */}
          <div className="tt-auth-hero text-white p-8 md:p-12 flex flex-col justify-between md:w-[42%] shrink-0 relative overflow-hidden bg-slate-900 dark:bg-[#12141f]">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <img 
                  src="/logo.png" 
                  alt="TaQ Bot Logo" 
                  className="tt-brand-mark w-10 h-10 rounded-xl object-cover border border-white/10 shadow-md"
                  onError={(e) => {
              ...
              <h2 className="text-2xl font-extrabold tracking-tight leading-tight pt-4">
                TaQ Bot Social Inbox & Automation Workspace
              </h2>
              <p className="text-slate-400 text-xs leading-relaxed">
                Connect your TikTok accounts, moderate post comments with AI keyword rules, and converse using our dual-pane Social Inbox driven by Google Gemini.
              </p>
            </div>
            ...
            <div className="space-y-4 pt-8">
              <div className="space-y-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-2 text-xs text-slate-300 font-medium">
                    <CheckCircle2 className="w-4 h-4 text-[#FE2C55] shrink-0" />
                    <span>AI Comment Moderation & Auto-Replies</span>
                  </div>
                  <div className="flex items-center gap-2 text-xs text-slate-300 font-medium">
                    <CheckCircle2 className="w-4 h-4 text-[#FE2C55] shrink-0" />
          ...
          {/* Right column forms */}
          <div className="tt-auth-form flex-1 p-8 md:p-12 flex flex-col justify-center bg-white dark:bg-[#161823]">
            <div className="max-w-md w-full mx-auto space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                    {isRegister 
                      ? "Launch a brand-new tenant account seeded with sample products & automation."
                      : "Enter your registered email and password credentials."}
                  </p>
                </div>
                <Link to="/" className="text-xs text-[#FE2C55] font-bold hover:underline flex items-center gap-1">
              ...
              {error && (
                <div className="bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800 p-4 rounded-xl flex items-start gap-3 text-xs text-rose-700 dark:text-rose-300 font-semibold">
              ...
              {!isRegister ? (
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 text-sm border border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-[#12141f] focus:outline-none focus:ring-2 focus:ring-[#FE2C55]/20"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="••••••••••••"
                        className="w-full pl-10 pr-10 py-2.5 text-sm border border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-[#12141f] focus:outline-none focus:ring-2 focus:ring-[#FE2C55]/20"
                      />
                      <button
                        type="button"
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-[#FE2C55] hover:bg-[#e02447] text-white font-bold py-2.5 rounded-xl text-sm transition-all shadow-md flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
                  >
                ...
                <form onSubmit={handleRegister} className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1 col-span-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-2 text-sm border border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-[#12141f] focus:outline-none focus:ring-2 focus:ring-[#FE2C55]/20"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2 text-sm border border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-[#12141f] focus:outline-none focus:ring-2 focus:ring-[#FE2C55]/20"
                      />
                    </div>

                    <div className="space-y-1">
                      <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase">Contact Phone</label>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-9 pr-3.5 py-2 text-sm border border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-[#12141f] focus:outline-none focus:ring-2 focus:ring-[#FE2C55]/20"
                        />
                      </div>
                    </div>

                    <div className="space-y-1 col-span-2">
                      <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase">TikTok Brand / Shop Name</label>
                      <input
                        type="text"
                        required
                        value={shopName}
                    ...
                    <div className="space-y-1 col-span-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={e => setPassword(e.target.value)}
                          placeholder="••••••••••••"
                          className="w-full pl-10 pr-10 py-2 text-sm border border-slate-200 dark:border-slate-700 rounded-xl bg-slate-50 dark:bg-[#12141f] focus:outline-none focus:ring-2 focus:ring-[#FE2C55]/20"
                        />
                        <button
                          type="button"
                          onClick={() => setShowPassword(!showPassword)}
                  ...
                  >
                    {loading ? "Creating Workspace..." : "Launch CRM Workspace"}
                    <ArrowRight className="w-4 h-4" />
                  </button>
                </form>
              )}
              ...
              <div className="space-y-3 pt-2">
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full bg-white dark:bg-[#12141f] hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 font-bold py-2.5 px-4 border border-slate-300 dark:border-slate-700 rounded-xl text-sm transition-all shadow-sm flex items-center justify-center gap-3 disabled:opacity-50 cursor-pointer"
                >
              ...
              <div className="text-center pt-2">
                <button
                  ...
                  className="text-xs font-bold text-[#FE2C55] hover:underline"
                >
              ...
              {/* Footer Links */}
              <div className="flex justify-center gap-4 pt-6 border-t border-slate-200 dark:border-slate-800 text-[11px] font-bold text-slate-400">
...
const AppContent: React.FC = () => {
  ...
  // Handle authenticated routing for dashboard routes
  if (user) {
    if (user.role === "SUPER_ADMIN") {
      ...
      if (path === "/dashboard" || path.startsWith("/dashboard") || path === "/settings") {
  ...
  if (path === "/login" || path === "/register") {
    if (user) {
      // Redirect logged-in user to their workspace
      return user.role === "SUPER_ADMIN" ? <SuperAdminDashboard /> : <TenantDashboard />;
    }
    return <AuthPortal />;
  }

  // Dashboard fallback for logged-in users visiting root
  if (user && (path === "/dashboard" || path === "/superadmin")) {
    return user.role === "SUPER_ADMIN" ? <SuperAdminDashboard /> : <TenantDashboard />;
  }

  // Default for unauthenticated root and unknown paths: Public Homepage!
  return <HomePage />;
};
