        ...
        <div className="border-t border-slate-100 pt-8 space-y-8">
          ...
          <div className="p-5 bg-slate-50/50 rounded-2xl border border-slate-100 space-y-2">
            ...
            <p className="text-slate-650 text-sm leading-relaxed font-medium">
              TikTokAuto respects user privacy. We are committed to protecting your personal data and ensuring transparency in how we collect and process information.
            </p>
          </div>
