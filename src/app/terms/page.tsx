        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-400 text-xs mt-1.5 font-medium uppercase tracking-wider">
              CreatorConnect Pro Platform Terms
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-slate-100 pt-8 space-y-8">
          ...
          <div className="p-5 bg-slate-50/50 rounded-2xl border border-slate-100 space-y-2">
            ...
            <p className="text-slate-655 text-sm leading-relaxed font-medium">
              CreatorConnect Pro provides advanced automation tools for creators. These tools are designed to streamline content management, comment moderation, and inbox interactions.
            </p>
          </div>
          ...
          <div className="p-5 bg-slate-50/50 rounded-2xl border border-slate-100 space-y-2">
            ...
            <p className="text-slate-655 text-sm leading-relaxed font-medium">
              Users are completely responsible for their own content, campaigns, and direct messages sent or automated via the CreatorConnect Pro platform.
            </p>
          </div>
        </div>
      </div>
