        ...
        <div className="border-t border-slate-100 pt-8 space-y-8">
          ...
          <div className="p-5 bg-slate-50/50 rounded-2xl border border-slate-100 space-y-2">
            ...
            <p className="text-slate-655 text-sm leading-relaxed font-medium">
              CreatorFlow AI provides advanced automation tools for creators. These tools are designed to streamline content management, comment moderation, and inbox interactions.
            </p>
          </div>
          ...
          <div className="p-5 bg-slate-50/50 rounded-2xl border border-slate-100 space-y-2">
            ...
            <p className="text-slate-655 text-sm leading-relaxed font-medium">
              Users are completely responsible for their own content, campaigns, and direct messages sent or automated via the CreatorFlow AI platform.
            </p>
          </div>
        </div>
      </div>
